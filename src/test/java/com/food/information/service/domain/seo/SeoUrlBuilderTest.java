...
public class SeoUrlBuilderTest {
    ...
    public Object[][] seoUrlBuilderDataProvider() {
        return new Object[][]{
                ...
                {"03808", "Infant formula, MEAD JOHNSON, ENFAMIL, LIPIL, with iron, powder, with ARA and DHA", "nutrition/03808/infant-formula-mead-johnson-enfamil-lipil-with" +
                        "-iron-powder-with-ara-and-dha?searchTerm=Infant formula, MEAD JOHNSON, ENFAMIL, LIPIL, with iron, powder, with ARA and DHA"},
                {"12345", "   This foOoOd iz! wild   --- ~`!@#$%^&*()_-[]{}\\|+='\";:?/.>,<", "nutrition/12345/this-fooood-iz-wild-percent-and-?searchTerm=   This foOoOd iz! " +
                        "wild   --- ~`!@#$%^&*()_-[]{}\\|+='\";:?/.>,<"}
        };
    }
